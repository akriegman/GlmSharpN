...
namespace GlmSharpGenerator
{
    static class Extensions
    {
        ...
        public static IEnumerable<string> DotComp(this string s, int maxComp = Program.N)
        {
            for (var i = 0; i < maxComp; ++i)
                yield return s + "." + Program.DIMS[i];
        }

        public static IEnumerable<string> ImpulseString(this int arg, string imp, string nonimp, int maxComp = Program.N)
        {
            for (var i = 0; i < maxComp; ++i)
