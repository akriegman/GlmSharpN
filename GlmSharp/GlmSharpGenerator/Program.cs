...
namespace GlmSharpGenerator
{
    class Program
    {
        ...
        public const string DIMS = "xyzwvuts";
        public const string CDIMS = "rgbaklpq";
        ...
        private static void Main(string[] args)
        {
            ...
            foreach (var version in new[] { 45, 20 })
            {
                ...
                {
                    case 45:
                        path = Path.Combine(basePath, String.Format("GlmSharp{0}", N));
                        testpath = Path.Combine(basePath, String.Format("GlmSharpTest{0}", N));
                        break;
                    case 20:
                        path = Path.Combine(basePath, String.Format("GlmSharpCompat{0}", N));
                        break;
                    default:
