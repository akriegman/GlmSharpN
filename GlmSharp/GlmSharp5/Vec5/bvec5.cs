...
namespace GlmSharp
{
    ...
    public struct bvec5 : IReadOnlyList<bool>, IEquatable<bvec5>
    {
        ...
        /// </summary>
        public bvec5(IReadOnlyList<bool> v)
        {
            var c = v.Count;
        ...
        /// </summary>
        public static explicit operator cvec2(bvec5 v) => new cvec2(v.x ? Complex.One : Complex.Zero, v.y ? Complex.One : Complex.Zero);
        
        /// <summary>
        /// Explicitly converts this to a cvec3.
        /// </summary>
        public static explicit operator cvec3(bvec5 v) => new cvec3(v.x ? Complex.One : Complex.Zero, v.y ? Complex.One : Complex.Zero, v.z ? Complex.One : Complex.Zero);
        
        /// <summary>
        /// Explicitly converts this to a cvec4.
        /// </summary>
        public static explicit operator cvec4(bvec5 v) => new cvec4(v.x ? Complex.One : Complex.Zero, v.y ? Complex.One : Complex.Zero, v.z ? Complex.One : Complex.Zero, v.w ? Complex.One : Complex.Zero);
        
        /// <summary>
        /// Explicitly converts this to a cvec5.
        /// </summary>
        public static explicit operator cvec5(bvec5 v) => new cvec5(v.x ? Complex.One : Complex.Zero, v.y ? Complex.One : Complex.Zero, v.z ? Complex.One : Complex.Zero, v.w ? Complex.One : Complex.Zero, v.v ? Complex.One : Complex.Zero);
