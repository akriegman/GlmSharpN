...
namespace GlmSharp
{
    ...
    /// <summary>
    /// A matrix of type uint with 5 columns and 5 rows.
    /// </summary>
    [Serializable]
    [DataContract(Namespace = "mat")]
    [StructLayout(LayoutKind.Sequential)]
    public struct umat5 : IReadOnlyList<uint>, IEquatable<umat5>
    {
        ...
        /// </summary>
        public umat5(uint m00, uint m01, uint m02, uint m03, uint m04, uint m10, uint m11, uint m12, uint m13, uint m14, uint m20, uint m21, uint m22, uint m23, uint m24, uint m30, uint m31, uint m32, uint m33, uint m34, uint m40, uint m41, uint m42, uint m43, uint m44)
        {
            this.m00 = m00;
            this.m01 = m01;
            this.m02 = m02;
        ...
        /// </summary>
        public umat5(uvec2 c0, uvec2 c1)
        {
            this.m00 = c0.x;
            this.m01 = c0.y;
            this.m02 = 0u;
        ...
        /// Constructs this matrix from a series of column vectors. Non-overwritten fields are from an Identity matrix.
        /// </summary>
        public umat5(uvec2 c0, uvec2 c1, uvec2 c2)
        {
            this.m00 = c0.x;
            this.m01 = c0.y;
            this.m02 = 0u;
        ...
        /// Constructs this matrix from a series of column vectors. Non-overwritten fields are from an Identity matrix.
        /// </summary>
        public umat5(uvec2 c0, uvec2 c1, uvec2 c2, uvec2 c3)
        {
            this.m00 = c0.x;
            this.m01 = c0.y;
            this.m02 = 0u;
        ...
        /// Constructs this matrix from a series of column vectors. Non-overwritten fields are from an Identity matrix.
        /// </summary>
        public umat5(uvec2 c0, uvec2 c1, uvec2 c2, uvec2 c3, uvec2 c4)
        {
            this.m00 = c0.x;
            this.m01 = c0.y;
            this.m02 = 0u;
        ...
        /// Constructs this matrix from a series of column vectors. Non-overwritten fields are from an Identity matrix.
        /// </summary>
        public umat5(uvec3 c0, uvec3 c1)
        {
            this.m00 = c0.x;
            this.m01 = c0.y;
            this.m02 = c0.z;
        ...
        /// Constructs this matrix from a series of column vectors. Non-overwritten fields are from an Identity matrix.
        /// </summary>
        public umat5(uvec3 c0, uvec3 c1, uvec3 c2)
        {
            this.m00 = c0.x;
            this.m01 = c0.y;
            this.m02 = c0.z;
        ...
        /// Constructs this matrix from a series of column vectors. Non-overwritten fields are from an Identity matrix.
        /// </summary>
        public umat5(uvec3 c0, uvec3 c1, uvec3 c2, uvec3 c3)
        {
            this.m00 = c0.x;
            this.m01 = c0.y;
            this.m02 = c0.z;
        ...
        /// Constructs this matrix from a series of column vectors. Non-overwritten fields are from an Identity matrix.
        /// </summary>
        public umat5(uvec3 c0, uvec3 c1, uvec3 c2, uvec3 c3, uvec3 c4)
        {
            this.m00 = c0.x;
            this.m01 = c0.y;
            this.m02 = c0.z;
        ...
        /// Constructs this matrix from a series of column vectors. Non-overwritten fields are from an Identity matrix.
        /// </summary>
        public umat5(uvec4 c0, uvec4 c1)
        {
            this.m00 = c0.x;
            this.m01 = c0.y;
            this.m02 = c0.z;
        ...
        /// Constructs this matrix from a series of column vectors. Non-overwritten fields are from an Identity matrix.
        /// </summary>
        public umat5(uvec4 c0, uvec4 c1, uvec4 c2)
        {
            this.m00 = c0.x;
            this.m01 = c0.y;
            this.m02 = c0.z;
        ...
        /// Constructs this matrix from a series of column vectors. Non-overwritten fields are from an Identity matrix.
        /// </summary>
        public umat5(uvec4 c0, uvec4 c1, uvec4 c2, uvec4 c3)
        {
            this.m00 = c0.x;
            this.m01 = c0.y;
            this.m02 = c0.z;
        ...
        /// Constructs this matrix from a series of column vectors. Non-overwritten fields are from an Identity matrix.
        /// </summary>
        public umat5(uvec4 c0, uvec4 c1, uvec4 c2, uvec4 c3, uvec4 c4)
        {
            this.m00 = c0.x;
            this.m01 = c0.y;
            this.m02 = c0.z;
        ...
        /// Constructs this matrix from a series of column vectors. Non-overwritten fields are from an Identity matrix.
        /// </summary>
        public umat5(uvec5 c0, uvec5 c1)
        {
            this.m00 = c0.x;
            this.m01 = c0.y;
            this.m02 = c0.z;
        ...
        /// Constructs this matrix from a series of column vectors. Non-overwritten fields are from an Identity matrix.
        /// </summary>
        public umat5(uvec5 c0, uvec5 c1, uvec5 c2)
        {
            this.m00 = c0.x;
            this.m01 = c0.y;
            this.m02 = c0.z;
        ...
        /// Constructs this matrix from a series of column vectors. Non-overwritten fields are from an Identity matrix.
        /// </summary>
        public umat5(uvec5 c0, uvec5 c1, uvec5 c2, uvec5 c3)
        {
            this.m00 = c0.x;
            this.m01 = c0.y;
            this.m02 = c0.z;
        ...
        /// Constructs this matrix from a series of column vectors. Non-overwritten fields are from an Identity matrix.
        /// </summary>
        public umat5(uvec5 c0, uvec5 c1, uvec5 c2, uvec5 c3, uvec5 c4)
        {
            this.m00 = c0.x;
            this.m01 = c0.y;
            this.m02 = c0.z;
        ...
        /// </summary>
        public uint[,] Values => new[,] { { m00, m01, m02, m03, m04 }, { m10, m11, m12, m13, m14 }, { m20, m21, m22, m23, m24 }, { m30, m31, m32, m33, m34 }, { m40, m41, m42, m43, m44 } };
        
        /// <summary>
        /// Creates a 1D array with all values (internal order)
        /// </summary>
        public uint[] Values1D => new[] { m00, m01, m02, m03, m04, m10, m11, m12, m13, m14, m20, m21, m22, m23, m24, m30, m31, m32, m33, m34, m40, m41, m42, m43, m44 };
        ...
        /// </summary>
        public uvec5 Column4
        {
            get
            {
                return new uvec5(m40, m41, m42, m43, m44);
            }
            set
            {
                m40 = value.x;
        ...
        public uvec5 Row4
        {
            get
            {
                return new uvec5(m04, m14, m24, m34, m44);
            }
            set
            {
                m04 = value.x;
        ...
        /// </summary>
        public static umat5 Zero { get; } = new umat5(0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u);
        
        /// <summary>
        /// Predefined all-ones matrix
        /// </summary>
        public static umat5 Ones { get; } = new umat5(1u, 1u, 1u, 1u, 1u, 1u, 1u, 1u, 1u, 1u, 1u, 1u, 1u, 1u, 1u, 1u, 1u, 1u, 1u, 1u, 1u, 1u, 1u, 1u, 1u);
        
        /// <summary>
        /// Predefined identity matrix
        /// </summary>
        public static umat5 Identity { get; } = new umat5(1u, 0u, 0u, 0u, 0u, 0u, 1u, 0u, 0u, 0u, 0u, 0u, 1u, 0u, 0u, 0u, 0u, 0u, 1u, 0u, 0u, 0u, 0u, 0u, 1u);
        
        /// <summary>
        /// Predefined all-MaxValue matrix
        /// </summary>
        public static umat5 AllMaxValue { get; } = new umat5(uint.MaxValue, uint.MaxValue, uint.MaxValue, uint.MaxValue, uint.MaxValue, uint.MaxValue, uint.MaxValue, uint.MaxValue, uint.MaxValue, uint.MaxValue, uint.MaxValue, uint.MaxValue, uint.MaxValue, uint.MaxValue, uint.MaxValue, uint.MaxValue, uint.MaxValue, uint.MaxValue, uint.MaxValue, uint.MaxValue, uint.MaxValue, uint.MaxValue, uint.MaxValue, uint.MaxValue, uint.MaxValue);
        
        /// <summary>
        /// Predefined diagonal-MaxValue matrix
        /// </summary>
        public static umat5 DiagonalMaxValue { get; } = new umat5(uint.MaxValue, 0u, 0u, 0u, 0u, 0u, uint.MaxValue, 0u, 0u, 0u, 0u, 0u, uint.MaxValue, 0u, 0u, 0u, 0u, 0u, uint.MaxValue, 0u, 0u, 0u, 0u, 0u, uint.MaxValue);
        
        /// <summary>
        /// Predefined all-MinValue matrix
        /// </summary>
        public static umat5 AllMinValue { get; } = new umat5(uint.MinValue, uint.MinValue, uint.MinValue, uint.MinValue, uint.MinValue, uint.MinValue, uint.MinValue, uint.MinValue, uint.MinValue, uint.MinValue, uint.MinValue, uint.MinValue, uint.MinValue, uint.MinValue, uint.MinValue, uint.MinValue, uint.MinValue, uint.MinValue, uint.MinValue, uint.MinValue, uint.MinValue, uint.MinValue, uint.MinValue, uint.MinValue, uint.MinValue);
        
        /// <summary>
        /// Predefined diagonal-MinValue matrix
        /// </summary>
        public static umat5 DiagonalMinValue { get; } = new umat5(uint.MinValue, 0u, 0u, 0u, 0u, 0u, uint.MinValue, 0u, 0u, 0u, 0u, 0u, uint.MinValue, 0u, 0u, 0u, 0u, 0u, uint.MinValue, 0u, 0u, 0u, 0u, 0u, uint.MinValue);
        ...
        /// </summary>
        public bool Equals(umat5 rhs) => (((((m00.Equals(rhs.m00) && m01.Equals(rhs.m01)) && (m02.Equals(rhs.m02) && m03.Equals(rhs.m03))) && ((m04.Equals(rhs.m04) && m10.Equals(rhs.m10)) && m11.Equals(rhs.m11))) && (((m12.Equals(rhs.m12) && m13.Equals(rhs.m13)) && m14.Equals(rhs.m14)) && ((m20.Equals(rhs.m20) && m21.Equals(rhs.m21)) && m22.Equals(rhs.m22)))) && ((((m23.Equals(rhs.m23) && m24.Equals(rhs.m24)) && m30.Equals(rhs.m30)) && ((m31.Equals(rhs.m31) && m32.Equals(rhs.m32)) && m33.Equals(rhs.m33))) && (((m34.Equals(rhs.m34) && m40.Equals(rhs.m40)) && m41.Equals(rhs.m41)) && ((m42.Equals(rhs.m42) && m43.Equals(rhs.m43)) && m44.Equals(rhs.m44)))));
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is umat5 && Equals((umat5) obj);
        }
        
        /// <summary>
        /// Returns true iff this equals rhs component-wise.
        /// </summary>
        public static bool operator ==(umat5 lhs, umat5 rhs) => lhs.Equals(rhs);
        ...
        /// </summary>
        public umat5 Transposed => new umat5(m00, m10, m20, m30, m40, m01, m11, m21, m31, m41, m02, m12, m22, m32, m42, m03, m13, m23, m33, m43, m04, m14, m24, m34, m44);
        
        /// <summary>
        /// Returns the minimal component of this matrix.
        /// </summary>
        public uint MinElement => Math.Min(Math.Min(Math.Min(Math.Min(Math.Min(Math.Min(Math.Min(Math.Min(Math.Min(Math.Min(Math.Min(Math.Min(Math.Min(Math.Min(Math.Min(Math.Min(Math.Min(Math.Min(Math.Min(Math.Min(Math.Min(Math.Min(Math.Min(Math.Min(m00, m01), m02), m03), m04), m10), m11), m12), m13), m14), m20), m21), m22), m23), m24), m30), m31), m32), m33), m34), m40), m41), m42), m43), m44);
        
        /// <summary>
        /// Returns the maximal component of this matrix.
        /// </summary>
        public uint MaxElement => Math.Max(Math.Max(Math.Max(Math.Max(Math.Max(Math.Max(Math.Max(Math.Max(Math.Max(Math.Max(Math.Max(Math.Max(Math.Max(Math.Max(Math.Max(Math.Max(Math.Max(Math.Max(Math.Max(Math.Max(Math.Max(Math.Max(Math.Max(Math.Max(m00, m01), m02), m03), m04), m10), m11), m12), m13), m14), m20), m21), m22), m23), m24), m30), m31), m32), m33), m34), m40), m41), m42), m43), m44);
        ...
        /// </summary>
        public uint Sum => (((((m00 + m01) + (m02 + m03)) + ((m04 + m10) + m11)) + (((m12 + m13) + m14) + ((m20 + m21) + m22))) + ((((m23 + m24) + m30) + ((m31 + m32) + m33)) + (((m34 + m40) + m41) + ((m42 + m43) + m44))));
        ...
        /// </summary>
        public float Norm1 => (((((m00 + m01) + (m02 + m03)) + ((m04 + m10) + m11)) + (((m12 + m13) + m14) + ((m20 + m21) + m22))) + ((((m23 + m24) + m30) + ((m31 + m32) + m33)) + (((m34 + m40) + m41) + ((m42 + m43) + m44))));
        ...
        /// </summary>
        public static umat5 operator<<(umat5 lhs, int rhs) => new umat5(lhs.m00 << rhs, lhs.m01 << rhs, lhs.m02 << rhs, lhs.m03 << rhs, lhs.m04 << rhs, lhs.m10 << rhs, lhs.m11 << rhs, lhs.m12 << rhs, lhs.m13 << rhs, lhs.m14 << rhs, lhs.m20 << rhs, lhs.m21 << rhs, lhs.m22 << rhs, lhs.m23 << rhs, lhs.m24 << rhs, lhs.m30 << rhs, lhs.m31 << rhs, lhs.m32 << rhs, lhs.m33 << rhs, lhs.m34 << rhs, lhs.m40 << rhs, lhs.m41 << rhs, lhs.m42 << rhs, lhs.m43 << rhs, lhs.m44 << rhs);
        ...
        /// </summary>
        public static bmat5 operator<(umat5 lhs, umat5 rhs) => new bmat5(lhs.m00 < rhs.m00, lhs.m01 < rhs.m01, lhs.m02 < rhs.m02, lhs.m03 < rhs.m03, lhs.m04 < rhs.m04, lhs.m10 < rhs.m10, lhs.m11 < rhs.m11, lhs.m12 < rhs.m12, lhs.m13 < rhs.m13, lhs.m14 < rhs.m14, lhs.m20 < rhs.m20, lhs.m21 < rhs.m21, lhs.m22 < rhs.m22, lhs.m23 < rhs.m23, lhs.m24 < rhs.m24, lhs.m30 < rhs.m30, lhs.m31 < rhs.m31, lhs.m32 < rhs.m32, lhs.m33 < rhs.m33, lhs.m34 < rhs.m34, lhs.m40 < rhs.m40, lhs.m41 < rhs.m41, lhs.m42 < rhs.m42, lhs.m43 < rhs.m43, lhs.m44 < rhs.m44);
        
        /// <summary>
        /// Executes a component-wise lesser-than comparison with a scalar.
        /// </summary>
        public static bmat5 operator<(umat5 lhs, uint rhs) => new bmat5(lhs.m00 < rhs, lhs.m01 < rhs, lhs.m02 < rhs, lhs.m03 < rhs, lhs.m04 < rhs, lhs.m10 < rhs, lhs.m11 < rhs, lhs.m12 < rhs, lhs.m13 < rhs, lhs.m14 < rhs, lhs.m20 < rhs, lhs.m21 < rhs, lhs.m22 < rhs, lhs.m23 < rhs, lhs.m24 < rhs, lhs.m30 < rhs, lhs.m31 < rhs, lhs.m32 < rhs, lhs.m33 < rhs, lhs.m34 < rhs, lhs.m40 < rhs, lhs.m41 < rhs, lhs.m42 < rhs, lhs.m43 < rhs, lhs.m44 < rhs);
        
        /// <summary>
        /// Executes a component-wise lesser-than comparison with a scalar.
        /// </summary>
        public static bmat5 operator<(uint lhs, umat5 rhs) => new bmat5(lhs < rhs.m00, lhs < rhs.m01, lhs < rhs.m02, lhs < rhs.m03, lhs < rhs.m04, lhs < rhs.m10, lhs < rhs.m11, lhs < rhs.m12, lhs < rhs.m13, lhs < rhs.m14, lhs < rhs.m20, lhs < rhs.m21, lhs < rhs.m22, lhs < rhs.m23, lhs < rhs.m24, lhs < rhs.m30, lhs < rhs.m31, lhs < rhs.m32, lhs < rhs.m33, lhs < rhs.m34, lhs < rhs.m40, lhs < rhs.m41, lhs < rhs.m42, lhs < rhs.m43, lhs < rhs.m44);
