...
namespace GlmSharp
{
    ...
    public struct cvec3 : IReadOnlyList<Complex>, IEquatable<cvec3>
    {
        ...
        /// </summary>
        public cvec3(cvec2 ve, Complex z)
        {
            this.x = ve.x;
            this.y = ve.y;
            this.z = z;
        ...
        /// </summary>
        public static explicit operator cvec5(cvec3 v) => new cvec5((Complex)v.x, (Complex)v.y, (Complex)v.z, Complex.Zero, Complex.Zero);
