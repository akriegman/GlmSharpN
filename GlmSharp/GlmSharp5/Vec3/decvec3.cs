...
namespace GlmSharp
{
    ...
    public struct decvec3 : IReadOnlyList<decimal>, IEquatable<decvec3>
    {
        ...
        /// </summary>
        public decvec3(decvec2 ve, decimal z)
        {
            this.x = ve.x;
            this.y = ve.y;
            this.z = z;
        ...
        /// </summary>
        public static explicit operator ivec5(decvec3 v) => new ivec5((int)v.x, (int)v.y, (int)v.z, 0, 0);
        ...
        /// </summary>
        public static explicit operator uvec5(decvec3 v) => new uvec5((uint)v.x, (uint)v.y, (uint)v.z, 0u, 0u);
        ...
        /// </summary>
        public static explicit operator vec5(decvec3 v) => new vec5((float)v.x, (float)v.y, (float)v.z, 0f, 0f);
        ...
        /// </summary>
        public static explicit operator hvec5(decvec3 v) => new hvec5((Half)v.x, (Half)v.y, (Half)v.z, Half.Zero, Half.Zero);
        ...
        /// </summary>
        public static explicit operator dvec5(decvec3 v) => new dvec5((double)v.x, (double)v.y, (double)v.z, 0.0, 0.0);
        ...
        /// </summary>
        public static explicit operator decvec5(decvec3 v) => new decvec5((decimal)v.x, (decimal)v.y, (decimal)v.z, 0m, 0m);
        ...
        /// </summary>
        public static explicit operator cvec5(decvec3 v) => new cvec5((Complex)v.x, (Complex)v.y, (Complex)v.z, Complex.Zero, Complex.Zero);
        ...
        /// </summary>
        public static explicit operator lvec5(decvec3 v) => new lvec5((long)v.x, (long)v.y, (long)v.z, 0, 0);
        ...
        /// </summary>
        public static explicit operator bvec5(decvec3 v) => new bvec5(v.x != 0m, v.y != 0m, v.z != 0m, false, false);
