...
namespace GlmSharp
{
    ...
    public struct mat2 : IReadOnlyList<float>, IEquatable<mat2>
    {
        ...
        /// <summary>
        /// Executes a matrix-matrix-multiplication mat2 * mat5x2 -> mat5x2.
        /// </summary>
        public static mat5x2 operator*(mat2 lhs, mat5x2 rhs) => new mat5x2((lhs.m00 * rhs.m00 + lhs.m10 * rhs.m01), (lhs.m01 * rhs.m00 + lhs.m11 * rhs.m01), (lhs.m00 * rhs.m10 + lhs.m10 * rhs.m11), (lhs.m01 * rhs.m10 + lhs.m11 * rhs.m11), (lhs.m00 * rhs.m20 + lhs.m10 * rhs.m21), (lhs.m01 * rhs.m20 + lhs.m11 * rhs.m21), (lhs.m00 * rhs.m30 + lhs.m10 * rhs.m31), (lhs.m01 * rhs.m30 + lhs.m11 * rhs.m31), (lhs.m00 * rhs.m40 + lhs.m10 * rhs.m41), (lhs.m01 * rhs.m40 + lhs.m11 * rhs.m41));
