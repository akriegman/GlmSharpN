...
namespace GlmSharp
{
    ...
    /// <summary>
    /// A matrix of type T with 5 columns and 3 rows.
    /// </summary>
    [Serializable]
    [DataContract(Namespace = "mat")]
    [StructLayout(LayoutKind.Sequential)]
    public struct gmat5x3<T> : IReadOnlyList<T>, IEquatable<gmat5x3<T>>
    {
        ...
        /// </summary>
        public gmat5x3(T m00, T m01, T m02, T m10, T m11, T m12, T m20, T m21, T m22, T m30, T m31, T m32, T m40, T m41, T m42)
        {
            this.m00 = m00;
            this.m01 = m01;
            this.m02 = m02;
        ...
        /// </summary>
        public gmat5x3(gvec2<T> c0, gvec2<T> c1)
        {
            this.m00 = c0.x;
            this.m01 = c0.y;
            this.m02 = default(T);
        ...
        /// Constructs this matrix from a series of column vectors. Non-overwritten fields are from an Identity matrix.
        /// </summary>
        public gmat5x3(gvec2<T> c0, gvec2<T> c1, gvec2<T> c2)
        {
            this.m00 = c0.x;
            this.m01 = c0.y;
            this.m02 = default(T);
        ...
        /// Constructs this matrix from a series of column vectors. Non-overwritten fields are from an Identity matrix.
        /// </summary>
        public gmat5x3(gvec2<T> c0, gvec2<T> c1, gvec2<T> c2, gvec2<T> c3)
        {
            this.m00 = c0.x;
            this.m01 = c0.y;
            this.m02 = default(T);
        ...
        /// Constructs this matrix from a series of column vectors. Non-overwritten fields are from an Identity matrix.
        /// </summary>
        public gmat5x3(gvec2<T> c0, gvec2<T> c1, gvec2<T> c2, gvec2<T> c3, gvec2<T> c4)
        {
            this.m00 = c0.x;
            this.m01 = c0.y;
            this.m02 = default(T);
        ...
        /// Constructs this matrix from a series of column vectors. Non-overwritten fields are from an Identity matrix.
        /// </summary>
        public gmat5x3(gvec3<T> c0, gvec3<T> c1)
        {
            this.m00 = c0.x;
            this.m01 = c0.y;
            this.m02 = c0.z;
        ...
        /// Constructs this matrix from a series of column vectors. Non-overwritten fields are from an Identity matrix.
        /// </summary>
        public gmat5x3(gvec3<T> c0, gvec3<T> c1, gvec3<T> c2)
        {
            this.m00 = c0.x;
            this.m01 = c0.y;
            this.m02 = c0.z;
        ...
        /// Constructs this matrix from a series of column vectors. Non-overwritten fields are from an Identity matrix.
        /// </summary>
        public gmat5x3(gvec3<T> c0, gvec3<T> c1, gvec3<T> c2, gvec3<T> c3)
        {
            this.m00 = c0.x;
            this.m01 = c0.y;
            this.m02 = c0.z;
        ...
        /// Constructs this matrix from a series of column vectors. Non-overwritten fields are from an Identity matrix.
        /// </summary>
        public gmat5x3(gvec3<T> c0, gvec3<T> c1, gvec3<T> c2, gvec3<T> c3, gvec3<T> c4)
        {
            this.m00 = c0.x;
            this.m01 = c0.y;
            this.m02 = c0.z;
        ...
        /// </summary>
        public T[,] Values => new[,] { { m00, m01, m02 }, { m10, m11, m12 }, { m20, m21, m22 }, { m30, m31, m32 }, { m40, m41, m42 } };
        
        /// <summary>
        /// Creates a 1D array with all values (internal order)
        /// </summary>
        public T[] Values1D => new[] { m00, m01, m02, m10, m11, m12, m20, m21, m22, m30, m31, m32, m40, m41, m42 };
        ...
        /// </summary>
        public gvec3<T> Column4
        {
            get
            {
                return new gvec3<T>(m40, m41, m42);
            }
            set
            {
                m40 = value.x;
        ...
        /// </summary>
        public static gmat5x3<T> Zero { get; } = new gmat5x3<T>(default(T), default(T), default(T), default(T), default(T), default(T), default(T), default(T), default(T), default(T), default(T), default(T), default(T), default(T), default(T));
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is gmat5x3<T> && Equals((gmat5x3<T>) obj);
        }
        
        /// <summary>
        /// Returns true iff this equals rhs component-wise.
        /// </summary>
        public static bool operator ==(gmat5x3<T> lhs, gmat5x3<T> rhs) => lhs.Equals(rhs);
        ...
        /// </summary>
        public gmat3x5<T> Transposed => new gmat3x5<T>(m00, m10, m20, m30, m40, m01, m11, m21, m31, m41, m02, m12, m22, m32, m42);
    }
}
