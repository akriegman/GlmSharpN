...
namespace GlmSharp
{
    ...
    public struct umat4x2 : IReadOnlyList<uint>, IEquatable<umat4x2>
    {
        ...
        /// <summary>
        /// Executes a matrix-matrix-multiplication umat4x2 * umat5x4 -> umat5x2.
        /// </summary>
        public static umat5x2 operator*(umat4x2 lhs, umat5x4 rhs) => new umat5x2(((lhs.m00 * rhs.m00 + lhs.m10 * rhs.m01) + (lhs.m20 * rhs.m02 + lhs.m30 * rhs.m03)), ((lhs.m01 * rhs.m00 + lhs.m11 * rhs.m01) + (lhs.m21 * rhs.m02 + lhs.m31 * rhs.m03)), ((lhs.m00 * rhs.m10 + lhs.m10 * rhs.m11) + (lhs.m20 * rhs.m12 + lhs.m30 * rhs.m13)), ((lhs.m01 * rhs.m10 + lhs.m11 * rhs.m11) + (lhs.m21 * rhs.m12 + lhs.m31 * rhs.m13)), ((lhs.m00 * rhs.m20 + lhs.m10 * rhs.m21) + (lhs.m20 * rhs.m22 + lhs.m30 * rhs.m23)), ((lhs.m01 * rhs.m20 + lhs.m11 * rhs.m21) + (lhs.m21 * rhs.m22 + lhs.m31 * rhs.m23)), ((lhs.m00 * rhs.m30 + lhs.m10 * rhs.m31) + (lhs.m20 * rhs.m32 + lhs.m30 * rhs.m33)), ((lhs.m01 * rhs.m30 + lhs.m11 * rhs.m31) + (lhs.m21 * rhs.m32 + lhs.m31 * rhs.m33)), ((lhs.m00 * rhs.m40 + lhs.m10 * rhs.m41) + (lhs.m20 * rhs.m42 + lhs.m30 * rhs.m43)), ((lhs.m01 * rhs.m40 + lhs.m11 * rhs.m41) + (lhs.m21 * rhs.m42 + lhs.m31 * rhs.m43)));
