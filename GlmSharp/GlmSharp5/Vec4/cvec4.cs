...
namespace GlmSharp
{
    ...
    public struct cvec4 : IReadOnlyList<Complex>, IEquatable<cvec4>
    {
        ...
        /// </summary>
        public cvec4(cvec2 ve, Complex z)
        {
            this.x = ve.x;
            this.y = ve.y;
            this.z = z;
        ...
        /// </summary>
        public cvec4(cvec2 ve, Complex z, Complex w)
        {
            this.x = ve.x;
            this.y = ve.y;
            this.z = z;
        ...
        /// from-vector-and-value constructor
        /// </summary>
        public cvec4(cvec3 ve, Complex w)
        {
            this.x = ve.x;
            this.y = ve.y;
            this.z = ve.z;
        ...
        /// </summary>
        public static explicit operator cvec5(cvec4 v) => new cvec5((Complex)v.x, (Complex)v.y, (Complex)v.z, (Complex)v.w, Complex.Zero);
