...
namespace GlmSharp
{
    ...
    public struct uvec4 : IReadOnlyList<uint>, IEquatable<uvec4>
    {
        ...
        /// </summary>
        public uvec4(uvec2 ve, uint z, uint w)
        {
            this.x = ve.x;
            this.y = ve.y;
            this.z = z;
        ...
        /// </summary>
        public static explicit operator ivec5(uvec4 v) => new ivec5((int)v.x, (int)v.y, (int)v.z, (int)v.w, 0);
        ...
        /// </summary>
        public static explicit operator uvec5(uvec4 v) => new uvec5((uint)v.x, (uint)v.y, (uint)v.z, (uint)v.w, 0u);
        ...
        /// </summary>
        public static explicit operator vec5(uvec4 v) => new vec5((float)v.x, (float)v.y, (float)v.z, (float)v.w, 0f);
        ...
        /// </summary>
        public static explicit operator hvec5(uvec4 v) => new hvec5((Half)v.x, (Half)v.y, (Half)v.z, (Half)v.w, Half.Zero);
        ...
        /// </summary>
        public static explicit operator dvec5(uvec4 v) => new dvec5((double)v.x, (double)v.y, (double)v.z, (double)v.w, 0.0);
        ...
        /// </summary>
        public static explicit operator decvec5(uvec4 v) => new decvec5((decimal)v.x, (decimal)v.y, (decimal)v.z, (decimal)v.w, 0m);
        ...
        /// </summary>
        public static explicit operator cvec5(uvec4 v) => new cvec5((Complex)v.x, (Complex)v.y, (Complex)v.z, (Complex)v.w, Complex.Zero);
        ...
        /// </summary>
        public static explicit operator lvec5(uvec4 v) => new lvec5((long)v.x, (long)v.y, (long)v.z, (long)v.w, 0);
        ...
        /// </summary>
        public static explicit operator bvec5(uvec4 v) => new bvec5(v.x != 0u, v.y != 0u, v.z != 0u, v.w != 0u, false);
