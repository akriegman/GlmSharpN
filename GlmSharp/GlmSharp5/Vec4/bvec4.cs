...
namespace GlmSharp
{
    ...
    public struct bvec4 : IReadOnlyList<bool>, IEquatable<bvec4>
    {
        ...
        /// </summary>
        public bvec4(bvec2 ve, bool z, bool w)
        {
            this.x = ve.x;
            this.y = ve.y;
            this.z = z;
        ...
        /// <summary>
        /// Explicitly converts this to a ivec5. (Higher components are zeroed)
        /// </summary>
        public static explicit operator ivec5(bvec4 v) => new ivec5(v.x ? 1 : 0, v.y ? 1 : 0, v.z ? 1 : 0, v.w ? 1 : 0, 0);
        ...
        /// <summary>
        /// Explicitly converts this to a uvec5. (Higher components are zeroed)
        /// </summary>
        public static explicit operator uvec5(bvec4 v) => new uvec5(v.x ? 1u : 0u, v.y ? 1u : 0u, v.z ? 1u : 0u, v.w ? 1u : 0u, 0u);
        ...
        /// <summary>
        /// Explicitly converts this to a vec5. (Higher components are zeroed)
        /// </summary>
        public static explicit operator vec5(bvec4 v) => new vec5(v.x ? 1f : 0f, v.y ? 1f : 0f, v.z ? 1f : 0f, v.w ? 1f : 0f, 0f);
        ...
        /// <summary>
        /// Explicitly converts this to a hvec5. (Higher components are zeroed)
        /// </summary>
        public static explicit operator hvec5(bvec4 v) => new hvec5(v.x ? Half.One : Half.Zero, v.y ? Half.One : Half.Zero, v.z ? Half.One : Half.Zero, v.w ? Half.One : Half.Zero, Half.Zero);
        ...
        /// <summary>
        /// Explicitly converts this to a dvec5. (Higher components are zeroed)
        /// </summary>
        public static explicit operator dvec5(bvec4 v) => new dvec5(v.x ? 1.0 : 0.0, v.y ? 1.0 : 0.0, v.z ? 1.0 : 0.0, v.w ? 1.0 : 0.0, 0.0);
        ...
        /// <summary>
        /// Explicitly converts this to a decvec5. (Higher components are zeroed)
        /// </summary>
        public static explicit operator decvec5(bvec4 v) => new decvec5(v.x ? 1m : 0m, v.y ? 1m : 0m, v.z ? 1m : 0m, v.w ? 1m : 0m, 0m);
        ...
        /// <summary>
        /// Explicitly converts this to a cvec5. (Higher components are zeroed)
        /// </summary>
        public static explicit operator cvec5(bvec4 v) => new cvec5(v.x ? Complex.One : Complex.Zero, v.y ? Complex.One : Complex.Zero, v.z ? Complex.One : Complex.Zero, v.w ? Complex.One : Complex.Zero, Complex.Zero);
        ...
        /// <summary>
        /// Explicitly converts this to a lvec5. (Higher components are zeroed)
        /// </summary>
        public static explicit operator lvec5(bvec4 v) => new lvec5(v.x ? 1 : 0, v.y ? 1 : 0, v.z ? 1 : 0, v.w ? 1 : 0, 0);
        ...
        /// <summary>
        /// Explicitly converts this to a bvec5. (Higher components are zeroed)
        /// </summary>
        public static explicit operator bvec5(bvec4 v) => new bvec5((bool)v.x, (bool)v.y, (bool)v.z, (bool)v.w, false);
