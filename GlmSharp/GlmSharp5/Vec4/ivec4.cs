...
namespace GlmSharp
{
    ...
    public struct ivec4 : IReadOnlyList<int>, IEquatable<ivec4>
    {
        ...
        /// </summary>
        public ivec4(ivec2 ve, int z, int w)
        {
            this.x = ve.x;
            this.y = ve.y;
            this.z = z;
        ...
        /// </summary>
        public static explicit operator ivec5(ivec4 v) => new ivec5((int)v.x, (int)v.y, (int)v.z, (int)v.w, 0);
        ...
        /// </summary>
        public static explicit operator uvec5(ivec4 v) => new uvec5((uint)v.x, (uint)v.y, (uint)v.z, (uint)v.w, 0u);
        ...
        /// </summary>
        public static explicit operator vec5(ivec4 v) => new vec5((float)v.x, (float)v.y, (float)v.z, (float)v.w, 0f);
        ...
        /// </summary>
        public static explicit operator hvec5(ivec4 v) => new hvec5((Half)v.x, (Half)v.y, (Half)v.z, (Half)v.w, Half.Zero);
        ...
        /// </summary>
        public static explicit operator dvec5(ivec4 v) => new dvec5((double)v.x, (double)v.y, (double)v.z, (double)v.w, 0.0);
        ...
        /// </summary>
        public static explicit operator decvec5(ivec4 v) => new decvec5((decimal)v.x, (decimal)v.y, (decimal)v.z, (decimal)v.w, 0m);
        ...
        /// </summary>
        public static explicit operator cvec5(ivec4 v) => new cvec5((Complex)v.x, (Complex)v.y, (Complex)v.z, (Complex)v.w, Complex.Zero);
        ...
        /// </summary>
        public static explicit operator lvec5(ivec4 v) => new lvec5((long)v.x, (long)v.y, (long)v.z, (long)v.w, 0);
        ...
        /// </summary>
        public static explicit operator bvec5(ivec4 v) => new bvec5(v.x != 0, v.y != 0, v.z != 0, v.w != 0, false);
