...
namespace GlmSharp
{
    ...
    public struct gvec4<T> : IEnumerable<T>, IEquatable<gvec4<T>>
    {
        ...
        /// </summary>
        public gvec4(gvec2<T> ve, T z, T w)
        {
            this.x = ve.x;
            this.y = ve.y;
            this.z = z;
        ...
        /// <summary>
        /// Explicitly converts this to a gvec5. (Higher components are zeroed)
        /// </summary>
        public static explicit operator gvec5<T>(gvec4<T> v) => new gvec5<T>((T)v.x, (T)v.y, (T)v.z, (T)v.w, default(T));
