...
namespace GlmSharp
{
    ...
    public struct imat2 : IEnumerable<int>, IEquatable<imat2>
    {
        ...
        /// <summary>
        /// Executes a matrix-matrix-multiplication imat2 * imat5x2 -> imat5x2.
        /// </summary>
        public static imat5x2 operator*(imat2 lhs, imat5x2 rhs) => new imat5x2((lhs.m00 * rhs.m00 + lhs.m10 * rhs.m01), (lhs.m01 * rhs.m00 + lhs.m11 * rhs.m01), (lhs.m00 * rhs.m10 + lhs.m10 * rhs.m11), (lhs.m01 * rhs.m10 + lhs.m11 * rhs.m11), (lhs.m00 * rhs.m20 + lhs.m10 * rhs.m21), (lhs.m01 * rhs.m20 + lhs.m11 * rhs.m21), (lhs.m00 * rhs.m30 + lhs.m10 * rhs.m31), (lhs.m01 * rhs.m30 + lhs.m11 * rhs.m31), (lhs.m00 * rhs.m40 + lhs.m10 * rhs.m41), (lhs.m01 * rhs.m40 + lhs.m11 * rhs.m41));
